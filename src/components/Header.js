  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
       <div>
          <button onClick={() => idioma.establecerLenguaje('es-ES')}><img src={es} alt="Bandera del país de España" width="42px" /></button>
					<button onClick={() => idioma.establecerLenguaje('en-US')}><img src={en} alt="Flag of Europe country United Kingdom" width="42px" /></button>
        </div>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <li className="pb-1 md:pb-0">
            ...
            <FormattedMessage 
                id="navProjects" 
                defaultMessage="Projects default"
              />
            </NavLink>
          </li>
          <li>
